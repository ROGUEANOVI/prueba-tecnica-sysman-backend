...
@AllArgsConstructor
@Builder
@Table(name = TableConstants.DEPARTMENT)
public class Department {
    ...
    @Column(name = ColumnConstants.NAME, length = NumericConstants.DEPARTMENT_NAME_MAX_LENGTH, nullable = false)
    @Size(max = NumericConstants.NAME_MAX_LENGTH)
    @NotBlank
    private String name;

    @OneToMany(mappedBy = TableConstants.DEPARTMENT, cascade = CascadeType.ALL, orphanRemoval = true)
